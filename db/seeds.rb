...
jimbo = User.create!({email: "jimbo@whatever.com", password_digest: "$2a$10$5.Bm2jJh0eZZPvZzU36ibuV1yVM76R7FTxl.GzojlfGsd7LSBDcuq", session_token: "j5ajPTmpCTzGUyP5IzrNaQ", activated: true, activation_token: "nwFl39k1wG5A-jUf_oKm4A", current_blog_id: nil})
